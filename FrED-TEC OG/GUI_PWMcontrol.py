...
class ControlGUI(QWidget):
    def __init__(self):
        ...
        # --- Entradas de control para identificación de sistema ---
        self.pwm_hotend_data = []   # u1: PWM real aplicado al calentador (0-255)
        self.pwm_motor_data  = []   # u2: PWM real aplicado al motor DC (0-255)
        self.pwm_fan_data    = []   # u3: PWM real aplicado al ventilador (0-255)
        self.sp_temp_data    = []   # r1: Setpoint de temperatura (°C)
        self.sp_rpm_data     = []   # r2: Setpoint de RPM
        ...
        try:
            with open(path, 'w', newline='') as f:
                ...
                writer.writerow([
                    ...
                    # --- Entradas de control u(t): PWM reales aplicados ---
                    'PWM_Hotend', 'PWM_Motor_DC', 'PWM_Fan',
                    # --- Referencias r(t): setpoints enviados ---
                    'Setpoint_Temp', 'Setpoint_RPM',
                    # --- Estados ON/OFF de actuadores ---
